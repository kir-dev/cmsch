...
Ha az **Email küldése felelős válaszkor** be van kapcsolva, a felelős válaszakor a rendszer emailt küld az ügyfélnek az **Válasz email sablon** mezőben megadott sablonnal. A sablonban elérhető változók: `{{title}}`, `{{message}}`, `{{solver}}`, `{{threadUrl}}`.
