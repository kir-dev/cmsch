...
class StylingComponent(
    ...
    var lightBackgroundColor by StringSettingRef("#FFFFFF", type = SettingType.COLOR,
        fieldName = "Háttérszín", description = "Az oldal hátterének a színe, ha nincs kép megadva, akkor ez látszik"
    )

    var lightContainerColor by StringSettingRef("transparent", type = SettingType.COLOR,
    ...
    var lightNavbarColor by StringSettingRef("transparent", type = SettingType.COLOR,
    ...
    var lightFooterBackground by StringSettingRef("transparent", type = SettingType.COLOR,
    ...
    var lightFooterShadowColor by StringSettingRef("#00000025", type = SettingType.COLOR,
        fieldName = "Footer alsó sáv színe", description = "Footer legalsó sávjának a színe"
    )

    var lightTextColor by StringSettingRef("#000000", type = SettingType.COLOR,
        fieldName = "Szövegszín", description = "A megjelenő szövegek színe"
    )

    var lightBrandingColor by StringSettingRef("#880000", type = SettingType.COLOR,
    ...
    var darkModeEnabled by BooleanSettingRef(false, fieldName = "Sötét téma elérhető",
        description = "Ha ez ki van kapcsolva, akkor nincs téma váltó"
    )

    var deviceTheme by BooleanSettingRef(false, fieldName = "Séma az eszköz alapján",
    ...
    var forceDarkMode by BooleanSettingRef(false, fieldName = "Csak a sötét téma érhető el",
        description = "Ha be van kapcsolva, akkor csak a sötét téma használható"
    )

    var darkBackgroundColor by StringSettingRef("#FFFFFF", type = SettingType.COLOR,
        fieldName = "Háttérszín", description = "Az oldal hátterének a színe, ha nincs kép megadva, akkor ez látszik"
    )

    var darkContainerColor by StringSettingRef("transparent", type = SettingType.COLOR,
        fieldName = "Lap színe", description = "A lap tartamának háttérszíne"
    )
    ...
    var darkNavbarColor by StringSettingRef("transparent", type = SettingType.COLOR,
        fieldName = "Navbar színe", description = "A Navbar háttérszíne"
    )
    ...
    var darkFooterBackground by StringSettingRef("transparent", type = SettingType.COLOR,
        fieldName = "Footer színe", description = "A Footer háttérszíne"
    )
    ...
    var darkFooterShadowColor by StringSettingRef("#00000025", type = SettingType.COLOR,
        fieldName = "Footer alsó sáv színe", description = "Footer legalsó sávjának a színe"
    )

    var darkTextColor by StringSettingRef("#000000", type = SettingType.COLOR,
        fieldName = "Szövegszín", description = "A megjelenő szövegek színe"
    )
    ...
    var mainFontName by StringSettingRef("'Open Sans', sans-serif", fieldName = "Általános betűtípus",
        description = "Az általános (pl. szöveg blockokban megjelenő) betűtípus neve"
    )

    var mainFontCdn by StringSettingRef("https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;600&display=swap",
        type = SettingType.URL, fieldName = "Általános betűtípus CDN",
        description = "Az általános betűtípus CDN URL-je", serverSideOnly = true
    )

    var mainFontWeight by StringSettingRef("300", fieldName = "Általános betűtípus vastagsága",
        description = "Az általános betűtípus vastagsága"
    )

    var displayFontName by StringSettingRef("'Bebas Neue', cursive", fieldName = "Kiemelt betűtípus",
        description = "A kiemelt (pl. fejlécként megjelenő) betűtípus neve. Ha üres akkor az általános lesz használva."
    )

    var displayFontCdn by StringSettingRef("https://fonts.googleapis.com/css2?family=Bebas+Neue&display=swap",
        type = SettingType.URL,
        fieldName = "Kiemelt betűtípus CDN",
        description = "A kiemelt betűtípus CDN URL-je",
        serverSideOnly = true
    )

    var displayFontWeight by StringSettingRef("400", fieldName = "Kiemelt betűtípus vastagsága",
