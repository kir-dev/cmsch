...
class ProfileComponent(
    ...
    final var title by StringSettingRef("Profil", fieldName = "Lap címe", description = "Ez jelenik meg a böngésző címsorában"
    )
    ...
    var showTasks by BooleanSettingRef(false, fieldName = "Feladat számláló aktív", description = "Legyen-e látható a feladat számláló?"
    )
    ...
    var showRiddles by BooleanSettingRef(false, fieldName = "Riddle számláló aktív", description = "Legyen-e látható a riddle számláló?"
    )
    ...
    var showTokens by BooleanSettingRef(false,
    ...
    val profileFieldsGroup by SettingGroup(        fieldName = "Profil adatok", description = "Milyen adatok jelenjenek meg a felhasználóról a profilban"
    )
    ...
    var showAlias by BooleanSettingRef(       false, fieldName = "Becenév látható", description = "Ha van nickneve, akkor ki legyen-e írva"
    )

    var aliasChangeEnabled by BooleanSettingRef(       false, fieldName = "Becenév szerkeszthető", description = "Lehet-e megváltoztatni a becenevet"
    )
    ...
    var showGroup by BooleanSettingRef(false, fieldName = "Csoport tagság látható",
        description = "Ki van írva, hogy melyik csoportnak a tagja"
    )

    var showGuild by BooleanSettingRef(false, fieldName = "Gárda látható", description = "Ki van írva, hogy melyik gárda"
    )

    var showMajor by BooleanSettingRef(false, fieldName = "Szak látható", description = "Ki van írva, hogy melyik szakra jár"
    )

    var showNeptun by BooleanSettingRef(false, fieldName = "Neptun kód látható", description = "Ki van írva a neptunkódja"
    )

    var showEmail by BooleanSettingRef(false, fieldName = "Emailcím látható", description = "Legyen kiírva az emailcíme"
    )

    var showProfilePicture by BooleanSettingRef(false, fieldName = "Profil kép látható"
    )

    var showQr by BooleanSettingRef(false, fieldName = "Egyedi QR kód látható",
    ...
    var showQrOnlyIfTicketPresent by BooleanSettingRef(false, serverSideOnly = true, fieldName = "QR csak ha van jegye",
        description = "A profil QR csak akkor látszik ha van jegye az illetőnek (Nem BMEJEGY)"
    )

    var qrTitle by StringSettingRef("CMSCH ID", fieldName = "QR kód fejléc", description = "Ez a fejléc jelenik meg a QR kód felett"
    )

    var bmejegyQrIfPresent by BooleanSettingRef(false, serverSideOnly = true,
    ...
    var messageBoxLevel by StringSettingRef("", fieldName = "Üzenet doboz típusa", description = "success, info, warning, error"
    )

    var showGroupMessage by BooleanSettingRef(false, serverSideOnly = true,
        fieldName = "Csoporthoz üzenet mutatása", description = "A csoporthoz tartozó üzenet kijelzése a profilban"
    )

    var showUserMessage by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Felhasználói üzenet mutatása",
    ...
    var showGroupLeaders by BooleanSettingRef(false,
    ...
    var showGroupLeadersLocations by BooleanSettingRef(false,
        fieldName = "Csoport helyzetének mutatása", description = "Csoport vezetők pozíciójának mutatása"
    )

    var locationTimeout by NumberSettingRef(600, serverSideOnly = true, fieldName = "Helyzet lejárata", strictConversion = false,
    ...
    var showMinimumTokenMessage by BooleanSettingRef(false,
        fieldName = "Minimum token üzenet aktív", description = "A szükséges összegyűjthető tokenekről legyen-e üzenet?"
    )

    var minTokenNotEnoughMessage by StringSettingRef(
    ...
    var showIncompleteProfile by BooleanSettingRef(false, fieldName = "Profil kitöltöttsége üzenet aktív",
    ...
    var profileComplete by StringSettingRef("A profil sikeresen ki lett töltve!", type = SettingType.LONG_TEXT,
