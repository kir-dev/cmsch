...
class LoginComponent(
    ...
    final var title by StringSettingRef("Belépés", fieldName = "Lap címe",
    ...
    var googleAdminAddresses by StringSettingRef(serverSideOnly = true, fieldName = "ADMIN jogú emailcímek",
        description = "Csak Google auth esetén! Ezeknek a felhasználóknak ADMIN joga lesz belépésnél. Az emailcímek vesszővel felsorolva.")
    ...
    var staffGroups by StringSettingRef(serverSideOnly = true, fieldName = "STAFF jogú Pék csoportok",
        description = "A pékes decimális id-k felsorolva, pl: 18,106")

    var staffGroupName by StringSettingRef("STAFF", serverSideOnly = true, fieldName = "Rendező csoport neve",
        description = "Csoport (group) neve amit megkapnak azok akiknek STAFF role is jár. Ha nem létező, akkor nem kapják meg.")

    var adminGroups by StringSettingRef(serverSideOnly = true, fieldName = "ADMIN jogú Pék csoportok",
        description = "A pékes decimális id-k felsorolva, pl: 18,106")
    ...
    var organizerGroups by StringSettingRef(serverSideOnly = true, fieldName = "Szervező Pék csoportok",
        description = "A pékes decimális id-k felsorolva, pl: 18,106")

    var organizerGroupName by StringSettingRef("Kiállító", serverSideOnly = true, fieldName = "Szervező csoport neve",
        description = "Csoport neve amit megkapnak felsorolt pék csoportokból, pl: Kiállító; Ha nem létező, akkor nem kapják meg.")

    var fallbackGroupName by StringSettingRef("Vendég", serverSideOnly = true, fieldName = "Fallback csoport neve",
