...
class BountyComponentController(
    ...
    5. **Játék** – a **Játék kezdete** után a játékos a körkártyáján látja a célpontját, a fegyverét, az élő létszámokat, a hátralévő idejét és a saját titkos kódját (ezt mutatja fel az áldozat). A **Gyilkolás** gombbal az áldozat kódja QR-kódról beolvasva vagy kézzel beírva küldhető be; csak a célpont csapat élő tagja ölhető meg, és egy kód csak a saját körében érvényes. A gyilkosság pontot ér, és újraindítja a gyilkos visszaszámlálóját.
