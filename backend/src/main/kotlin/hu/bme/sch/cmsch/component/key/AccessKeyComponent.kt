...
class AccessKeyComponent(
    ...
    var disabledErrorMessage by StringSettingRef(
        "Jelenleg nem lehet kódot beváltani",
        fieldName = "Kikapcsolt hibaüzenet", description = "Ez jelenik meg ha ki van kapcsolva",
        serverSideOnly = true,
    )

    var invalidCodeErrorMessage by StringSettingRef(
        "Nem megfelelő kód",
        fieldName = "Hibás kód hibaüzenet", description = "Ez jelenik meg ha hibás kódot írnak be",
        serverSideOnly = true,
    )

    var alreadyUsedErrorMessage by StringSettingRef(
        "Ez a kód már be lett váltva", fieldName = "Kód be lett váltva hibaüzenet",
        description = "Ez jelenik meg ha ez a kód már be lett váltva", serverSideOnly = true,
    )

    var mustLogInErrorMessage by StringSettingRef(
        "Nem vagy bejelentkezve", fieldName = "Nem lett bejelentkezve hibaüzenet",
        description = "Ez jelenik meg ha ez a nincs bejelentkezve", serverSideOnly = true,
    )

    var youUsedErrorMessage by StringSettingRef(
        "Te már használtál fel kódot", fieldName = "Te már használtál fel hibaüzenet",
    ...
    var fieldName by StringSettingRef(
        "Kód", fieldName = "Mező neve",
    ...
    var enabled by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Lehet beváltani",
        description = "Ha ez be van kapcsolva, akkor lehetséges csak beváltani kulcsokat"
    )

    var canOneUserUseMultiple by BooleanSettingRef(false,
        fieldName = "Egy felhasználó többet is beválthat",
        serverSideOnly = true,
