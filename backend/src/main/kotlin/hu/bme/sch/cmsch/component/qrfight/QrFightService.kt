...
class QrFightService(
    ...
    private fun handleTowerCaptureForGroup(
        ...
        towerEntity.history += objectMapper.writeValueAsString(TowerHistoryEntry(userId = user.id, ownerGroup = groupName, ownerGroupId = groupId, timestamp = clock.getTimeInSeconds())) + "\n"
