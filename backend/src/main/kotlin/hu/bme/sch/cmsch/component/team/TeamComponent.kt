...
class TeamComponent(
    ...
    var myTitle by StringSettingRef("Csapatom", fieldName = "Csapatom lap címe", description = "Ez jelenik meg a böngésző címsorában"
    )
    ...
    final var title by StringSettingRef("Csapatok", fieldName = "Csapatok lap címe", description = "Ez jelenik meg a böngésző címsorában"
    )
    ...
    var showTeamsAtAll by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Csapat lista kijelzése",
        description = "Ha ki van kapcsolva a akkor a csapat lista nincs leküldve"
    )

    var showNotRacingTeams by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Nem versenyző csapatok kijelzése",
        description = "Azoknak is a kijelzése akik nem versenyeznek"
    )

    var showNotManualTeams by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Admin által nevezett csapatok is látszanak",
        description = "Azoknak is a kijelzése akiket az admin panelről neveztek"
    )

    var sortByName by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Név alapján rendezés",
    ...
    var creationEnabled by BooleanSettingRef(false, fieldName = "Csoport készítés engedélyezve",
    ...
    var teamLogoUploadEnabled by BooleanSettingRef(false, fieldName = "Csoport logó feltöltés engedélyezése",
        description = "Ha igaz, lehet a vezetőknek logót feltölteni"
    )

    var joinEnabled by BooleanSettingRef(false, fieldName = "Csatlakozás engedélyezve",
        description = "Ha igaz, lehet csapathoz csatlakozni"
    )

    var leaveEnabled by BooleanSettingRef(false, fieldName = "Kilépés engedélyezve",
        description = "Ha igaz, lehet ki lehet lépni csapatból"
    )

    var grantPrivilegedRole by BooleanSettingRef(true, serverSideOnly = true, fieldName = "PRIVILEGED jog a csapat készítőjének",
    ...
    var showTeamDetails by BooleanSettingRef(false, fieldName = "Csoport részleteinek mutatása",
        description = "Ha be val kapcsolva, akkor a csapatok adatai megtekinthetőek"
    )

    var showTeamMembersPublicly by BooleanSettingRef(false, fieldName = "Csoport tagjai publikusak",
        description = "Ha be val kapcsolva, akkor a csapatok adatai megtekinthetőek"
    )

    var showTeamScore by BooleanSettingRef(false, fieldName = "Csoport pontjának kijelzése",
        description = "Ha be val kapcsolva, akkor az adatlapon kint lesz a csoport pontjainak a mutatója"
    )

    var showTeamScoreDetailsButton by BooleanSettingRef(false, fieldName = "Csoport részletes pontjaihoz gomb",
        description = "Ha be val kapcsolva, akkor megjelenik egy gomb a csapat részletes pont listájához"
    )

    var showRaceButton by BooleanSettingRef(false, fieldName = "Mérés gomb látszódik", description = "Ha igaz, látszik a gomb"
    )
    ...
    var membersStatEnabled by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Tagok számának kijelzése",
    ...
    var placeStatEnabled by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Helyezés kijelzése",
    ...
    var scoreStatEnabled by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Pontszám kijelzése",
    ...
    var qrFightStatEnabled by BooleanSettingRef(false, serverSideOnly = true, fieldName = "QR Fight kijelzése",
    ...
    var raceStatEnabled by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Verseny eredmény kijelzése",
    ...
    var riddleStatEnabled by BooleanSettingRef(false, serverSideOnly = true, fieldName = "Riddle eredmény kijelzése",
