...
A lista tartalmazza az összes rögzített eseményt, státuszukkal együtt (látható / jogosultsági szint / időpont).
...
- **Cím** – az esemény neve.
- **Url** – rövid azonosító az esemény webcíméhez (csak kisbetűk és kötőjelek). A frontenden ${appComponent.siteUrl}new/{url} linken érhető el.
