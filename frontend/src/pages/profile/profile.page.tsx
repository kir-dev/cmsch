...
const GroupMap = React.lazy(() => import('@/common-components/map/GroupMapContainer'))
...
const ProfilePage = () => {
  ...
  return (
    <CmschPage loginRequired={true} title={component?.title}>
      ...
      {(component.showTasks || component.showRiddles || component.showTokens) && <Separator className="my-8 h-0.5" />}
      ...
      {component.showGroupLeadersLocations && <GroupMap />}
    </CmschPage>
  )
}
