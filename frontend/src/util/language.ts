...
const languageData = {
  ...
  'unauthorized-page-helmet': 'Nincs bejelentkezve',
  ...
  'event-list-message': 'A változás jogát fenntartjuk! Kísérje figyelemmel az oldal tetején megjelenő értesítéseket!',
