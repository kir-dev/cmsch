...
export const AUTHSCH_REDIRECT_PATH = process.env.REACT_APP_AUTHSCH_REDIRECT_PATH || 'auth/success'
export const AUTHSCH_CLIENT_ID = process.env.REACT_APP_AUTHSCH_CLIENT_ID || ''
export const AUTHSCH_CLIENT_SECRET = process.env.REACT_APP_AUTHSCH_CLIENT_SECRET || ''
